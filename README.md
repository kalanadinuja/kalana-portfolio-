...
- **EmailJS** – contact form (if implemented)
...
- 📬 **Contact Form** – send messages directly (optional)
- 📱 **Fully Responsive** – works on all devices (mobile, tablet, desktop)
- 🌓 **Dark / Light Mode** – optional theme switcher

## 👤 My Profile

- **Name:** Kalana Dinuja
- **Role:** Full Stack Developer | 3rd Year IT Student at SLIIT
- **Interests:** Web Development, Mobile Apps, Cloud Computing
- **GitHub:** [github.com/kalanadinuja](https://github.com/kalanadinuja)
- **LinkedIn:** [linkedin.com/in/kalana-dinuja](https://www.linkedin.com/in/kalana-dinuja-19530634b/)
